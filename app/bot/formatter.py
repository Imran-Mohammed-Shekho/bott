...
def format_help_message(default_interval_seconds: int) -> str:
    ...
    return "\n".join(
        [
            ...
            "/connectsession - paste session JSON directly in Telegram",
            "/savesession - save pasted session JSON",
            "/cancelsession - cancel session capture mode",
            "/disconnectsession - remove stored execution session",
